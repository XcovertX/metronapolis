...
const LAYOUT: Partial<Record<number, Partial<Record<SceneId, { x: number; y: number }>>>> = {
  ...
  0: {
    "lobby": { x: 260, y: 210 },
    "elevator": { x: 280, y: 210 },
    "security-desk": { x: 240, y: 210 },
    "maintenance-office": { x: 200, y: 210 },
    "service-hall": { x: 240, y: 170 },
    "building-laundry": { x: 220, y: 170 },
    "stairwell-mid": { x: 200, y: 190 },
    "courtyard-int": { x: 260, y: 230 },
    "street-front": { x: 260, y: 300 },
    "sidewalk-north": { x: 260, y: 335 },
    "sidewalk-south": { x: 260, y: 250 },
    "street-alley": { x: 300, y: 300 },
    "courtyard-ext": { x: 280, y: 230 },
    "service-door": { x: 240, y: 150 },
    "loading-zone": { x: 285, y: 150 },
    "alley-entrance": { x: 300, y: 230 },
    "alley-mid": { x: 300, y: 200 },
    "dumpster": { x: 315, y: 200 },
    "dead-end": { x: 300, y: 150 },
    "bike-rack": { x: 280, y: 250 },
    "side-street-west": { x: 95, y: 300 },
    "street-store": { x: 360, y: 300 },
    "store-front": { x: 360, y: 360 },
    "store-interior": { x: 360, y: 380 },
    "store-stock": { x: 360, y: 400 },
    "laundromat-front": { x: 300, y: 360 },
    "laundromat-interior": { x: 300, y: 380 },
    "streetlight": { x: 425, y: 360 },
    "cafe-front": { x: 410, y: 360 },
    "cafe-interior": { x: 410, y: 380 },
    "cafe-back": { x: 410, y: 400 },
    "clinic-front": { x: 500, y: 360 },
    "clinic-waiting": { x: 520, y: 360 },
    "phone-booth": { x: 520, y: 375 },
    "ticket-kiosk": { x: 90, y: 470 },
    "transit-platform": { x: 30, y: 470 },
    "side-street-east": { x: 460, y: 360 },
  },
  [-1]: {
    "basement-storage": { x: 280, y: 120 },
    "boiler-room": { x: 190, y: 120 },
  },
  2: {
